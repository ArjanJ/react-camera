...
function (_PureComponent) {
  ...
  function Camera(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleIntersectionObserver", function (_ref) {
    ...
    /*#__PURE__*/
    _regeneratorRuntime.mark(function _callee() {
      var _this$state$constrain, facingMode, height, width;

      return _regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _this$state$constrain = _this.state.constraints.video, facingMode = _this$state$constrain.facingMode, height = _this$state$constrain.height, width = _this$state$constrain.width;
              _context.next = 3;
    ...
    var constraints = buildConstraints(_facingMode, _height, _width);
    ...
    _this.changeFacingMode = _this.changeFacingMode.bind(_assertThisInitialized(_this));

    if (supportsIntersectionObserver) {
      _this.io = new IntersectionObserver(_this.handleIntersectionObserver);
    }
  ...
  _createClass(Camera, [{
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee4(prevProps, prevState) {
        var isIntersecting, _this$state$constrain2, facingMode, height, width, constraints;
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                _this$state$constrain2 = this.state.constraints.video, facingMode = _this$state$constrain2.facingMode, height = _this$state$constrain2.height, width = _this$state$constrain2.width;
                constraints = buildConstraints(facingMode, height, width);
                _context4.next = 7;
                return this.getMediaStream(constraints);

              case 7:
                return _context4.abrupt("return", this.setVideoStream());

              case 10:
                return _context4.abrupt("return", this.stopMediaStream());
    ...
    key: "changeFacingMode",
    value: function () {
      var _changeFacingMode = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee5() {
        var facingMode,
            _this$state$constrain3,
            height,
            width,
            constraints,
            _args5 = arguments;
        ...
        return _regeneratorRuntime.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                facingMode = _args5.length > 0 && _args5[0] !== undefined ? _args5[0] : '';
              ...
              case 3:
                this.stopMediaStream();
                _this$state$constrain3 = this.state.constraints.video, height = _this$state$constrain3.height, width = _this$state$constrain3.width;
                constraints = buildConstraints(facingMode, height, width);
                _context5.next = 8;
                return this.getMediaStream(constraints);
      ...
      function changeFacingMode() {
        return _changeFacingMode.apply(this, arguments);
      }

      return changeFacingMode;
    }()
  }, {
    key: "getMediaStream",
    value: function () {
    ...
    value: function () {
      ...
      /*#__PURE__*/
      _regeneratorRuntime.mark(function _callee7(imageCapture) {
    ...
    value: function render() {
      ...
      var _this$state = this.state,
          _this$state$constrain4 = _this$state.constraints,
          constraints = _this$state$constrain4 === void 0 ? {} : _this$state$constrain4,
          devices = _this$state.devices,
          error = _this$state.error;
      var multipleDevices = devices && devices.length > 1;
      var facingMode = constraints.video.facingMode;
      return error ? React__default.createElement(CameraError, {
        errorType: error
      }) : React__default.createElement(CameraWrapper, null, React__default.createElement("video", {
        autoPlay: true,
        playsInline: true,
